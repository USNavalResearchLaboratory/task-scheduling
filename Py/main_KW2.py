...
from tree_search import branch_bound, mc_tree_search, random_sequencer, earliest_release, earliest_release_swap, earliest_drop, earliest_drop_swap
...
# Algorithms
algorithms = [partial(earliest_release_swap, ch_avail=ch_avail),
              partial(earliest_release, ch_avail=ch_avail),
              partial(earliest_drop, ch_avail=ch_avail),
              partial(earliest_drop_swap, ch_avail=ch_avail),
