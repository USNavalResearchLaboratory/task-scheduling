...
# problem_gen = problem_gens.Random.continuous_relu_drop(n_tasks=5, n_ch=1, rng=None, duration_lim=(0,.05), t_release_lim=(0,0), slope_lim=(0,2), t_drop_lim=(0,6), l_drop_lim=(300,300))
...
l_ex_iter, t_run_iter = evaluate_algorithms(algorithms, problem_gen, n_gen=100, solve=True, verbose=2, plotting=1,
                                            data_path=None)
# l_ex_iter, t_run_iter = evaluate_algorithms(algorithms, problem_gen, n_gen=10, solve=True,
#                                             verbose=2, plotting=1, save=True, save_path=None)
