...
#                                            n_batch_train=10, n_batch_val=10, batch_size=4, weight_func=weight_func_,
...
#         list(problem_gen(n_gen=1000, solve=True, verbose=True, save=True, file=f'temp/relu_c{n_ch}t{n_tasks}_1000'))
