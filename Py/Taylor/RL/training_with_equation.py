def training_with_equation_function(number_of_tasks,features_indices,number_of_steps,F_training,F_testing,permutations,zero_cost_reward,episodes,alpha,gamma,epsilon):

    print("\n\nExecuting 'training_with_equation.py' ...")
    ...
    for i in range(1,episodes+1):
        ...
        for j in range(len(F_training)-1):
            ...
            Q_state_next = observations_to_state_q_matrix_function(number_of_tasks,r_N_steps,w_N_steps,l_N_steps,r_state_next,w_state_next,l_state_next)
