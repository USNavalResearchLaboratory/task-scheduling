function [C,t_ex,ChannelAvailableTime,NumDropTask] = FunctionMultiChannelSequenceScheduler(T,N,K,s_task,w_task,deadline_task,length_task,drop_task,ChannelAvailableTime)
