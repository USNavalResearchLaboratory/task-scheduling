function [Tfinal,Tstar,Tdr,NodeStats] = BBwithStats(data)

% This function performs Branch and Bound Algorithm 
%
...
% data.s_task = [0 0 0 0]';
% data.w_task = [.1 .2 .3 .4]';
% data.length_task = [1 1 1 1]';
% data.deadline_task = [1 -1 1.5 1.6]; 
% drop_task = 100*ones(4,1);
...
%                     end
                    ...
                    Snew.BestCost = Cbest;
%                     if isempty(PFprime)
%                         Snew(end).CompleteSolutionFlag = 1;
%                     end
