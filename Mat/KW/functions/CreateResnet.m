function  lgraph = CreateResnet(InputSize,OutputSize)


netWidth = 16;
layers = [
    imageInputLayer([InputSize(1) InputSize(2) InputSize(3)],'Name','input')
    ...
    averagePooling2dLayer([3 1],'Name','globalPool')
