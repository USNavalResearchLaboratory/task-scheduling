function [Tfinal,Tstar,Tdr] = BBschedulerStack(K,s_task,deadline_task,length_task,drop_task,w_task)
...
UB = inf; % Upper Bound
S = struct('T',[],'PF',(1:N)','NS',[],'DR',[],'t_ex',zeros(N,1),'ChannelAvailableTime',zeros(K,1),'ChannelAssignment',zeros(N,1),'x',zeros(N,1));
Snew = S;
