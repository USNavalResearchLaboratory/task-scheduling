function [Tfinal,Tstar,Tdr] = BBscheduler(K,s_task,deadline_task,length_task,drop_task,w_task)
...
%                     keyboard
                ...
                [t_partial,x_partial,ChannelAvailableTimePartial,PartialChannelAssignment] = BBActiveSequenceScheduler(PartialSchedule,s_task,deadline_task,length_task,ChannelAvailableTimeInput,ChannelSelected);
