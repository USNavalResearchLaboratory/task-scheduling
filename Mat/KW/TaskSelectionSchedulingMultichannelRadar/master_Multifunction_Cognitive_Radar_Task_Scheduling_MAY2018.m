...
%         Ta = [T1; NS(1); NS(2); NS(3)];
%         Tb = [T1; NS(1); NS(3); NS(2)];
%         Tc = [T1; NS(2); NS(1); NS(3)];
%         Td = [T1; NS(2); NS(3); NS(1)];
%         Te = [T1; NS(3); NS(1); NS(2)];
%         Tf = [T1; NS(3); NS(2); NS(1)];
% 
%         
%         CostCheck(1) = MultiChannelSequenceScheduler(Ta,N,K,s_task,w_task,deadline_task,length_task,drop_task);
%         CostCheck(2) = MultiChannelSequenceScheduler(Tb,N,K,s_task,w_task,deadline_task,length_task,drop_task);
%         CostCheck(3) = MultiChannelSequenceScheduler(Tc,N,K,s_task,w_task,deadline_task,length_task,drop_task);
%         CostCheck(4) = MultiChannelSequenceScheduler(Td,N,K,s_task,w_task,deadline_task,length_task,drop_task);
%         CostCheck(5) = MultiChannelSequenceScheduler(Te,N,K,s_task,w_task,deadline_task,length_task,drop_task);
%         CostCheck(6) = MultiChannelSequenceScheduler(Tf,N,K,s_task,w_task,deadline_task,length_task,drop_task);
